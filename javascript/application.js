...
def encrypt(plaintext, passphrase, iter: 200000)
  salt = SecureRandom.random_bytes(16)
  iv   = SecureRandom.random_bytes(12)   # GCM standard IV size
  ...
  Base64.strict_encode64(JSON.generate(json))
end
...
decrypt('eyJzYWx0IjoiNkx6NmR6bUFNclIwUnIraXNFVFI3dz09IiwiaXYiOiIxekhwTXFTTFFGRCtyenVZIiwidGFnIjoiVWRBUFpyR3hyTHhtNUFISjcvRlhMUT09IiwiaXRlciI6MjAwMDAwLCJkYXRhIjoiTEo3QzIzemIxQzJpRFliekF2ejQ5QT09In0=', '**[7]** con virgola e maiuscola')
